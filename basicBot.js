    ...
    var basicBot = {
        ...
        settings: {
            ...
            skipReasons: [
                ...
                ['som', 'A música que você tocou tem baixa qualidade sonora ou sem som. '],
                ['nsfw', 'A música que você tocou é NSFW (image or sound). '],
                ['bug', 'A música que você tocou está bloqueada para alguns usuários. ']
            ],
            afkpositionCheck: 15,
            ...
            rulesLink: null,
            themeLink: null,
            fbLink: 'https://www.facebook.com/groups/panelinhadobananalpocodeuranio/',
            youtubeLink: null,
            website: null,
            intervalMessages: [],
            messageInterval: 5,
        ...
        commands: {
            ...
            */
            ...
            ballCommand: {
                command: ['8ball', 'ask', 'perguntar', 'bola', 'bolinha'],
                rank: 'user',
                type: 'startsWith',
                functionality: function(chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void(0);
            ...
            */
            ...
            ghostbusterCommand: {
                command: ['ghostbuster', 'caçafantasma'],
                rank: 'user',
                type: 'startsWith',
                functionality: function(chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void(0);
            ...
            rouletteCommand: {
                command: ['roulette', 'roleta', 'rodaroda', 'rodamrodam'],
                rank: 'mod',
                type: 'exact',
                functionality: function(chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void(0);
